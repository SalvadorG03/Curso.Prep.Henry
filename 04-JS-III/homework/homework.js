...
function numeroMasGrande(numeros) {
  ...
  // Tu código:
var MayorN = numeros[0];
for (let i = 0; i<numeros.length;i++) {
 if (MayorN<numeros[i]) {MayorN=numeros[i];}
} return MayorN;
}
...
function cuentoElementos(arreglo){
  ...
  //Escribe tu código aquí
  var arregloMasDe18 = 0;
for (let i =0; i<arreglo.length;i++) {
  if (arreglo[i]>18) {arregloMasDe18=arregloMasDe18+1;}
}
  return arregloMasDe18;
}
